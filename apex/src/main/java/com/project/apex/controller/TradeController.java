...
//import com.project.apex.websocket.ClientExample;
...
//
//    @Autowired
//    public TradeController( OptionChainService optionChainService) {
//        Assert.notNull(optionChainService, "optionChainService must not be null");
//        this.optionChainService = optionChainService;
//    }
//
//    @GetMapping("/getFullOptionsChain")
//    public ResponseEntity<ApiResponse<List<OptionChainBean>>> getFullOptionsChain(@RequestParam String symbol, @RequestParam String optionType) throws IOException {
