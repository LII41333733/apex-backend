    ...
    public void fetchOrders() {
        ...
        try {
            ...
            if (orders == null) {
                ...
                TradeRecord<BaseTrade> baseTradeRecord = baseTradeManager.watch(baseTradeMap, BASE);
                TradeRecord<LottoTrade> lottoTradeRecord = lottoTradeManager.watch(lottoTradeMap, LOTTO);
